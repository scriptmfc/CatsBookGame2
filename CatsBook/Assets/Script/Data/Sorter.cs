...
public class Sorter : MonoBehaviour {
    ...
    {
        //int origin_len = unit.origin.x ^ 2 + unit.origin.y ^ 2;
        //int sort_len = sortedUnit.origin.x ^ 2 + sortedUnit.origin.y ^ 2;
        if(unit.transform.position.y <= sortedUnit.transform.position.y)
        {
            return true;
        }
        //else if(unit.origin.x < sortedUnit.origin.x) 
        //{
